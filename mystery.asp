...
<head>
	...
	<title>Amazon || Mystery & Thriller</title>
    ...
    <div class="modal-footer">
     <a class="modal-trigger"href="#modal1" class=" modal-action modal-close waves-effect waves-green btn-flat">Not an Existing User?</a>
      <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">Agree</a>
	   ...
	   <hr>
		 <h5 align="center"><i><font face="algerian">Mystery & Thriller</font></i></h5> 
		  <hr>
        ...
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=11" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=73" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/gone.jpg">
              <span class="card-title"></span>
            </div>
            
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=13" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2  ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "> <i class="material-icons">shopping_cart</i>
              <a href="product.asp?id=14" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=64" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2   ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=16" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        ...
        <div class="col s2   ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=19" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
