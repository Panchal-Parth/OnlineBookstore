...
<head>
	...
	<title>Amazon || Love & Romance</title>
    ...
    <div class="modal-footer">
     <a class="modal-trigger"href="#modal1" class=" modal-action modal-close waves-effect waves-green btn-flat">Not an Existing User?</a>
      <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">Agree</a>
	   ...
	   <hr>
		 <h5 align="center"><i><font face="algerian">Love & Romance</font></i></h5> 
		  <hr>
        ...
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=1" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=2" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/je.jpg">
              <span class="card-title"></span>
            </div>
            
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=3" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2  ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "> <i class="material-icons">shopping_cart</i>
              <a href="product.asp?id=4" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col s2 offset-s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=6" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
        ...
        <div class="col s2   ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=8" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        ...
        <div class="col s2   ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=10" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
