  ...
  <div id="modal2" class="modal">
    ...
    <div class="modal-footer">
     <a class="modal-trigger"href="#modal1" class=" modal-action modal-close waves-effect waves-green btn-flat">Not an Existing User</a>
      <a href="LibVal.asp" class=" modal-action modal-close waves-effect waves-green btn-flat">Agree</a>
    </div>
  </div>
      </header>
          
		 <h5 align="center">Author 1</h5> 
        ...
        <div class="row" >
			<div class="offset-s1 col s3">
			     Book1
				<img class="materialboxed"src="nature.jpg" width="300px" height="300px">
			</div> 
		
	   
			<div class="offset-sl col s3">
			     Book2
				<img class="materialboxed"src="nature.jpg" width="300px" height="300px">
			</div> 
