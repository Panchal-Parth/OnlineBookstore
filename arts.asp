...
<head>
	...
	<title>Amazon || Arts & Philosophy</title>
...
<body>
	...
	<!--Import jQuery before materialize.js-->
      ...
      <!--******************************header***************************-->
	   ...
	   <hr>
		 <h5 align="center"><i><font face="algerian">Arts & Philosophy</font></i></h5> 
		  <hr>
        ...
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=22" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=23" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=24" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
        <div class="col s2  ">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "> <i class="material-icons">shopping_cart</i>
              <a href="product.asp?id=25" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col s2 offset-s2">
          <div class="card hoverable">
            ...
            <div class="card-action"style="background-color:yellow "><i class="material-icons">shopping_cart</i> 
              <a href="product.asp?id=28" class="black-text">BUY NOW</a>
            </div>
          </div>
        </div>
